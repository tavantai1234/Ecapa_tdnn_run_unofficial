...
DATASET_ROOT = Path("/Users/tavantai/Developer/project_thesis_code/dataset_copy")
OUTPUT_DIR = Path("/Users/tavantai/Developer/project_thesis_code")
...
def main() -> None:
    ...
    train_rows, dev_rows = split_train_dev(
        speakers, training_spks, rng
    )
    enrol_rows, test_rows = split_enrol_test(
        speakers, verification_spks, rng
    )
    trials = create_trials(enrol_rows, test_rows, rng)

    validate_split(train_rows, dev_rows, enrol_rows, test_rows)
    ...
    print("Training speakers:", training_spks)
    print("Verification speakers:", verification_spks)
